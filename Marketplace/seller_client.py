...
# List of (host, port) for all seller server replicas
SERVER_ADDRS = [('localhost', 5003)]
current_server = 0
...
def send(method, path, data=None, params=None):
    global session_id, seller_id, current_server
...
if __name__ == '__main__':
    ...
    parser.add_argument('--servers', type=str, default='localhost:5003',
                        help='Comma-separated seller server addresses (host:port)')
